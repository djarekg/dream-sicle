...
public class CustomersController(CustomerService customerService) : ControllerBase
{
  ...
  {
    if (string.IsNullOrWhiteSpace(request.Name) || string.IsNullOrWhiteSpace(request.StreetAddress) || string.IsNullOrWhiteSpace(request.City) || string.IsNullOrWhiteSpace(request.StateId) || string.IsNullOrWhiteSpace(request.Zip) || string.IsNullOrWhiteSpace(request.Phone))
    {
